...
const ra9_event_1 = require("./events/ra9-event");
...
const ra9_node_1 = require("./node/ra9-node");
const ra9_intention_1 = require("./intention/ra9-intention");
const brain_config_1 = require("./brain/brain-config");
const conversation_limits_1 = require("./conversation/conversation-limits");
const openai_cheap_models_1 = require("./brain/openai-cheap-models");
...
let Ra9Module = Ra9Module_1 = class Ra9Module {
    static forRoot(options) {
        ...
        const brainConfig = (0, brain_config_1.resolveRa9BrainConfig)(options.brain);
        (0, openai_cheap_models_1.resolveCheapOpenAiModel)(brainConfig.model);
        ...
        const registryProvider = {
            provide: ra9_node_1.RA9_NODE_REGISTRY,
        ...
        const intentionRegistryProvider = {
            provide: ra9_intention_1.RA9_INTENTION_REGISTRY,
            useFactory: (...instances) => {
                const map = new Map();
        ...
        return {
            ...
            providers: [
                ...
                { provide: brain_config_1.RA9_BRAIN_CONFIG, useValue: brainConfig },
                ...
                ...extraListeners,
                {
                    provide: ra9_event_1.RA9_EVENT_LISTENERS,
            ...
            exports: [
                ...
                brain_config_1.RA9_BRAIN_CONFIG,
                ...
                vapi_sse_compiler_1.VapiSseCompiler,
                call_turn_queue_1.CallTurnQueueRegistry,
                ra9_node_1.RA9_NODE_REGISTRY,
                ra9_intention_1.RA9_INTENTION_REGISTRY,
                conversation_entry_1.CONVERSATION_ENTRY_POINT,
                ra9_event_1.RA9_EVENT_LISTENERS,
                workflow_loader_1.WorkflowLoader,
                workflow_handoff_service_1.WorkflowHandoffService,
                forms_service_1.FormsService,
...
exports.Ra9Module = Ra9Module;
exports.Ra9Module = Ra9Module = Ra9Module_1 = __decorate([
    (0, common_1.Module)({})
], Ra9Module);
//# sourceMappingURL=ra9.module.js.map