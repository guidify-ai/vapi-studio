...
import type { BrainClarifyRequest, BrainClarifyResult } from './brain-clarify';
import type { BrainJudgeRequest, BrainJudgeResult } from './brain-judge';
...
export declare const BRAIN_SERVICE: unique symbol;
/** Same token as BRAIN_SERVICE — prefer this name at the app boundary. */
export declare const BRAIN_ADAPTER: symbol;
//# sourceMappingURL=brain.port.d.ts.map