 ...
 */
export { BRAIN_SERVICE, BRAIN_ADAPTER, } from './brain.port';
export type { BrainService, BrainAdapter, BrainScanInput, BrainScanResult, } from './brain.port';
export type { BrainJudgeRequest, BrainJudgeOptions, BrainJudgeResult, } from './brain-judge';
export { MockBrainAdapter, MockBrainService, } from './adapters/mock-brain.adapter';
