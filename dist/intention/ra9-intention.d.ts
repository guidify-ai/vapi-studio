 ...
 */
export declare abstract class Ra9Intention<TSchema extends ConversationSchema = DefaultConversationSchema> {
...
export declare const RA9_INTENTION_REGISTRY: unique symbol;
...
//# sourceMappingURL=ra9-intention.d.ts.map