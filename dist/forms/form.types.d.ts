...
export declare class FormDeliverTimeoutError extends Error {
    readonly exposeId: string;
    readonly conversationId: string;
    readonly code: "FORM_DELIVER_TIMEOUT";
    constructor(exposeId: string, conversationId: string);
}
export declare class FormFilloutTimeoutError extends Error {
    readonly exposeId: string;
    readonly conversationId: string;
    readonly code: "FORM_FILLOUT_TIMEOUT";
    constructor(exposeId: string, conversationId: string);
}
export declare class FormChannelUnavailableError extends Error {
    readonly code: "FORM_CHANNEL_UNAVAILABLE";
