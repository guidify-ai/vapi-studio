 ...
 */
export declare abstract class AgentNode<TSchema extends ConversationSchema = DefaultConversationSchema> {
    /**
...
export declare const STUDIO_NODE_REGISTRY: unique symbol;
